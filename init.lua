...
vim.opt.showtabline = 0 -- don't show the tab line
vim.opt.winbar = "%=%m %f" --show filename at top-right
...
-- Use Zsh as the default shell in Neovim
...
vim.cmd(' autocmd BufNewFile *.html 0r ~/.config/nvim/skeleton.html')
